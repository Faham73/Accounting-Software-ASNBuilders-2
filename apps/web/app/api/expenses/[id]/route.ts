  ...
  try {
    ...
    const expense = await prisma.expense.update({
      ...
      data: {
        ...
        mainProjectId,
        date: expenseDate,
        categoryId: validatedData.categoryId ?? existingExpense.categoryId,
        ...
        // Only update accounting fields if voucher is not POSTED
        ...(existingExpense.voucher.status !== 'POSTED' && {
          amount: validatedData.amount ?? Number(existingExpense.amount),
          paymentMethodId: validatedData.paymentMethodId ?? existingExpense.paymentMethodId,
          debitAccountId: validatedData.debitAccountId ?? existingExpense.debitAccountId,
          creditAccountId: validatedData.creditAccountId ?? existingExpense.creditAccountId,
        }),
      },
      include: {
        project: {
