...
function ExpenseForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Validation
    if (!selectedMainProjectId) {
      alert('Main project is required');
      return;
    }
    ...
    if (!formData.debitAccountId) {
      alert('Debit account (expense account) is required');
      return;
    }
    if (!formData.creditAccountId) {
      alert('Credit account (payment account) is required');
      return;
    }
      ...
      <div className="bg-white rounded-lg shadow-xl p-8 max-w-3xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Debit Account (Expense) <span className="text-red-500">*</span>
              </label>
              <select
                required
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Credit Account (Payment) <span className="text-red-500">*</span>
              </label>
              <select
                required
